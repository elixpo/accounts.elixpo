            ...
            <Box sx={{ maxWidth: "800px", mx: "auto" }}>
                ...
                <Box sx={cardSx}>
                    ...
                    >
                        <Box>
                            <Typography
                                sx={{ color: "#f5f5f4", fontWeight: 600 }}
                            >
                                Active
                            </Typography>
                            <Typography
                ...
                <Box sx={cardSx}>
                    <Typography
                        sx={{ color: "#f5f5f4", fontWeight: 600, mb: 1 }}
                    >
                        Send Test Payload
                    </Typography>
                    <Typography
                    ...
                    >
                        Sends a <code style={{ color: "#a3e635" }}>ping</code>{" "}
                ...
                {/* Danger Zone */}
                <Box
                    sx={{ ...cardSx, border: "1px solid rgba(239,68,68,0.35)" }}
                >
                    <Typography
                    ...
                    <Divider
                        sx={{ borderColor: "rgba(239,68,68,0.2)", mb: 2 }}
                    />
                    <Box
                        sx={{
                            display: "flex",
                    ...
                    >
                        <Box>
                            <Typography
                                sx={{ color: "#f5f5f4", fontWeight: 500 }}
                            >
                                Delete webhook
                            </Typography>
                            <Typography
