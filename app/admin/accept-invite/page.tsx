      ...
      >
        {status === 'loading' && (
          <>
            ...
            <Typography sx={{ color: '#f5f5f4' }}>Validating invitation...</Typography>
          </>
        )}

        {status === 'ready' && (
          <>
            <Typography variant="h5" sx={{ fontWeight: 700, color: '#f5f5f4', mb: 1 }}>
              Admin Invitation
            </Typography>
            <Typography sx={{ color: 'rgba(255,255,255,0.6)', mb: 1 }}>
              You have been invited to become an administrator on Elixpo Accounts.
            </Typography>
            <Typography sx={{ color: '#a3e635', fontSize: '0.95rem', mb: 3 }}>
              {email}
            </Typography>
        ...
        {status === 'accepting' && (
          <>
            <CircularProgress sx={{ color: '#a3e635', mb: 2 }} />
            <Typography sx={{ color: '#f5f5f4' }}>Accepting invitation...</Typography>
          </>
        )}
        ...
        {status === 'success' && (
          <>
            ...
            <Typography variant="h5" sx={{ fontWeight: 700, color: '#a3e635', mb: 1 }}>
              Welcome, Admin!
            </Typography>
            <Typography sx={{ color: 'rgba(255,255,255,0.6)', mb: 3 }}>{message}</Typography>
        ...
        {status === 'error' && (
          <>
            <Box sx={{ fontSize: '3rem', mb: 1, color: '#ef4444' }}>&#10007;</Box>
