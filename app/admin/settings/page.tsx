...
import { CheckCircle, Notifications, Save } from "@mui/icons-material";
import {
    Alert,
    Box,
    Button,
        ...
        <Box>
                    ...
                    <Grid container spacing={3}>
                        ...
                        <Grid size={{ xs: 12, sm: 6 }}>
                            <TextField
                                ...
                                type="number"
                                value={
                                    settings.emailVerificationOtpExpiryMinutes
                                }
                                onChange={(e) =>
                                    handleSettingChange(
            ...
            >
                <CardContent>
                    ...
                    >
                        Configure which events trigger email notifications to
                    ...
                    >
                        ...
                        <FormControlLabel
                            ...
                            label={
                                <Box>
                                    ...
                                    >
                                        Email when a developer registers a new
                                        OAuth app
                                    </Typography>
                                </Box>
                            }
                        ...
                        <FormControlLabel
                            ...
                            label={
                                <Box>
                                    ...
                                    >
                                        Email when a user generates a new API
                                        key
                                    </Typography>
                                </Box>
                            }
                        ...
                        <FormControlLabel
                            control={
                                <Switch
                                    checked={
                                        notifSettings.email_suspicious_login
                                    }
                                    onChange={(e) =>
                                        handleNotifChange(
                            ...
                            label={
                                <Box>
                                    ...
                                    >
                                        Email on repeated failed logins or
                                        anomalous activity
                                    </Typography>
                                </Box>
                            }
                        ...
                        <FormControlLabel
                            ...
                            label={
                                <Box>
                                    ...
                                    >
                                        Periodic summary of platform activity (
                                        {notifSettings.digest_frequency})
                                    </Typography>
                                </Box>
                            }
                        />
