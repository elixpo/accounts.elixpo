...
const ErrorContent = () => {
    ...
    const errorMessages: { [key: string]: string } = {
        "access_denied":
            "Access was denied. Please check your credentials and try again.",
        "invalid_request":
            "Invalid request. Please contact support if the problem persists.",
    ...
    return (
        ...
        >
            ...
            >
                ...
                <Typography
                    variant="h4"
                    sx={{ fontWeight: 700, color: "#f87171", mb: 2 }}
                >
                    {error}
                </Typography>
