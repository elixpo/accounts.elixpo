...
function AuthorizeContent() {
    ...
    const [authRequest, setAuthRequest] = useState<AuthorizationRequest | null>(
        null,
    );
        ...
        const load = async () => {
            ...
            try {
                ...
                const [configRes, clientRes] = await Promise.all([
                    ...
                    fetch(
                        `/api/auth/oauth-clients?client_id=${encodeURIComponent(clientId)}`,
                    ),
                ]);
                ...
                if (configRes.ok) {
                    ...
                    setTimeRemaining(
                        (config as any).authorizationTimeoutSeconds || 600,
                    );
                }
        ...
        const timer = setInterval(() => {
            setTimeRemaining((prev) => {
                if (prev <= 1) {
                    clearInterval(timer);
                    setHasTimedOut(true);
                    setError("Authorization request expired.");
                    return 0;
                }
                return prev - 1;
            });
        ...
        return (
            ...
            >
                <div style={{ textAlign: "center" }}>
                    ...
                    />
                    <p style={{ color: "rgba(25,40,55,0.4)", fontSize: 14 }}>
                        Loading...
                    </p>
                ...
                >
                    ...
                    >
                        ...
                        <div
                            style={{
                                flexShrink: 0,
                                border: "2px solid rgba(25,40,55,0.1)",
                                borderRadius: 12,
                                overflow: "hidden",
                            }}
                        >
                    ...
                    >
                        ...
                        <div
                            style={{
                                background: "rgba(25,40,55,0.025)",
                                border: "1px solid rgba(25,40,55,0.1)",
                                borderRadius: 12,
                                padding: 14,
                            }}
                            ...
                            style={{
                                background:
                                    timeRemaining < 60
                                        ? "rgba(239,68,68,0.06)"
                                        : "rgba(25,40,55,0.025)",
                                border: `1px solid ${timeRemaining < 60 ? "rgba(239,68,68,0.15)" : "rgba(25,40,55,0.1)"}`,
                                borderRadius: 12,
                                padding: 14,
                                display: "flex",
                                flexDirection: "column",
