...
// URL validator. Without it, a write to identities.provider_profile_url
// (e.g. via DB compromise or a future bug in the callback) could turn
// /api/avatar into an open redirect.
