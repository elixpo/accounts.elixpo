...
**On approval:**
```
https://yourapp.com/callback?code=CODE&state=STATE
```

**On denial:**
```
https://yourapp.com/callback?error=access_denied&state=STATE
```
...
- The authorization code is **single-use** and cannot be reused
