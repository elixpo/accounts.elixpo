    ...
    return (
        <Box>
            ...
            <Typography sx={{ color: "rgba(255, 255, 255, 0.7)", mb: 4, lineHeight: 1.6 }}>
                Open <code>http://localhost:3000</code> in your browser to view the Elixpo login/registration and developer dashboard.
            </Typography>
            ...
            <Box component="ol" sx={{ color: "rgba(255, 255, 255, 0.7)", pl: 3, mb: 4, "& li": { mb: 1.5, lineHeight: 1.6 } }}>
                <li>
                    <strong>Database:</strong> Create a Cloudflare D1 database named <code>elixpo_auth</code> in the Cloudflare dashboard.
                </li>
                <li>
                    <strong>Pages Project:</strong> Connect your repository to Cloudflare Pages. Select <code>Next.js (App Router)</code> preset.
                </li>
                <li>
                    <strong>Bindings:</strong> In your Cloudflare Pages project settings, bind your D1 database to the variable name <code>DB</code>.
                </li>
                <li>
                    <strong>Environment Variables:</strong> Configure required production variables under Pages Dashboard:
                    <ul>
                        <li><code>JWT_SECRET</code>: High-entropy string for signing Access/Refresh tokens.</li>
                        <li><code>SMTP_HOST</code> / <code>SMTP_USER</code> / <code>SMTP_PASS</code> / <code>SMTP_PORT</code>: Configures sockets-based SMTP transport for sending transactional emails (OTP, resets).</li>
                    </ul>
                </li>
            </Box>
