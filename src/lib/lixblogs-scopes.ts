...
export const LIXBLOGS_SCOPE_DETAILS = {
    ...
    "lixblogs:integrations:cloudinary:read": {
        ...
        description: "Check whether a personal Cloudinary account is connected for storing media.",
        highImpact: false,
     },
     "lixblogs:integrations:cloudinary:disconnect": {
         label: "Disconnect Cloudinary",
         description: "Remove your personal Cloudinary connection. Media already stored there is not deleted, but new uploads will use LixBlogs' default storage instead.",
         highImpact: true,
     },
